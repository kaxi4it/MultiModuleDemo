package com.commonlib.views.indexbar;
...
import com.commonlib.entity.indexbar.BaseIndexPinyinBean;
...
public class IndexBar extends View {
    ...
    private int mDefultBackground;//手指未按下时的背景色
    private int mTextPressedColor;//手指按下时的文字颜色
    private int mTextDefultColor;//手指未按下时的文字颜色
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mPressedBackground = typedArray.getColor(R.styleable.IndexBar_indexBarPressBackground, Color.parseColor("#000000"));//点击默认黑色
        mDefultBackground = typedArray.getColor(R.styleable.IndexBar_indexBarDefaultBackground, Color.parseColor("#FFFFFF"));//未点击默认白色
        mTextPressedColor = typedArray.getColor(R.styleable.IndexBar_indexBarPressTextColor, Color.parseColor("#FFFFFF"));//未点击默认白色
        mTextDefultColor = typedArray.getColor(R.styleable.IndexBar_indexBarDefaultTextColor, Color.parseColor("#000000"));//未点击默认黑色
        textSize = typedArray.getDimensionPixelOffset(R.styleable.IndexBar_indexBarTextSize, mTextSize);
        ...
        setBackgroundColor(mDefultBackground);
        mPaint = new Paint();
        mPaint.setAntiAlias(true);
        mPaint.setTextSize(textSize);
        mPaint.setColor(mTextDefultColor);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        switch (event.getAction()) {
            ...
            default:
                setBackgroundColor(mDefultBackground);//手指抬起时背景恢复透明
                mPaint.setColor(mTextDefultColor);
                //回调监听器
                if (null != mOnIndexPressedListener) {
