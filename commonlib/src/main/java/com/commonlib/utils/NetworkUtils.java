...
public class NetworkUtils {
    ...
    private static NetworkInfo getActiveNetworkInfo() {
        return ((ConnectivityManager) BaseConfig.application.getSystemService(Context.CONNECTIVITY_SERVICE)).getActiveNetworkInfo();
    }
    ...
    public static boolean isAvailableByPing() {
        ShellUtils.CommandResult result = ShellUtils.execCmd("ping -c 1 -w 5 www.baidu.com", false);
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager cm = (ConnectivityManager) BaseConfig.application
